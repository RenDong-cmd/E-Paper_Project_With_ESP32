...
bool Audio2::connecttospeech(const char *speech, const char *lang)
{
    ...
    strcat(resp,    "&tok=24.f1115ef8382d857ec4f9d38c60d7ad36.2592000.1783769259.282335-122599436&");
    strcat(resp, "cuid=QWtIFZfqJfRsDf4vVC4M0a4kuKMMmUQR&");//xGUehEOfXZvUVQj5Zr6zf5zx7B57w9rD
    strcat(resp, "ctp=1&");
    strcat(resp, "lan=zh&");
    strcat(resp, "spd=4&");
    strcat(resp, "pit=5&");
